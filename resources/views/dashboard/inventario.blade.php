...
<form method="post" action="{{url('dashboard/addInventario')}}">
    @csrf
    ...
    <div class="form-group">
        <label for="description">Codigo de zona, barcode</label>
        <input type="text" class="form-control" id="description" name="description" required>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default"
                            onclick="JsBarcode('#barcode', '{{$producto->barcode}}', {format: 'ITF14'});">
                            Ver Codigo
                        </button>
                        <a href="{{url('dashboard/editInventario/'.$producto->id)}}" class="btn btn-primary">Editar</a>
                        <a href="{{url('dashboard/deleteInventario/'.$producto->id)}}"
