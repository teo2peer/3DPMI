...
'fecha_limite' --}}
<h2>Agregar Zona</h2>
<form method="post" action="{{url('dashboard/zonas/add')}}">
    @csrf
...
<form method="post" action="{{url('dashboard/zonas/subzonas/add')}}">
    @csrf
    <div class="form-group">
...
<button type="button" class="btn btn-primary mt-2 mb-2" onclick="window.location.href ='/dashboard/zonas/imprimir'">
    Imprimir todas las subzonas
</button>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{url('dashboard/zonas/delete/'.$zona->id)}}" class="btn btn-danger">Eliminar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default"
                            onclick="JsBarcode('#barcode', '{{$subzona->barcode}}', {format: 'EAN8'});">
                            Ver Codigo
                        </button>
                        {{-- DELETE --}}
                        <a href="{{url('dashboard/zonas/subzonas/delete/'.$subzona->id)}}"
